...
Version `0.2.1` is released from the `main` branch.

| Platform | Package |
|----------|---------|
| macOS Apple Silicon | `TeXada_0.2.1_aarch64.dmg` |
| macOS Intel | `TeXada_0.2.1_x64.dmg` |
| Windows x64 | `TeXada_0.2.1_x64-setup.exe` |
