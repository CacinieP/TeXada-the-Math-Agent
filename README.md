...
Version `0.3.3` is released from the `main` branch.

| Platform | Package |
|----------|---------|
| macOS Apple Silicon | `TeXada_0.3.3_aarch64.dmg` |
| macOS Intel | `TeXada_0.3.3_x64.dmg` |
| Windows x64 | `TeXada_0.3.3_x64-setup.exe` |
